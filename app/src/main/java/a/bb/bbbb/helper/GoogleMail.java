...
public class GoogleMail {
    ...
    public static MimeMessage createEmail(String to, String cc, String from, String subject) throws MessagingException {
    ...
    public static void Send(Gmail service, String recipientEmail, String ccEmail, String fromEmail, String title, String message) throws IOException, MessagingException {
        Message m = createMessageWithEmail(createEmail(recipientEmail, ccEmail, fromEmail, title));
